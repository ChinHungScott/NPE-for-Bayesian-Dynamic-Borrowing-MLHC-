...
\begin{figure}[!tbp]
    \centering
    \includegraphics[width=.70\textwidth]{fig_sim_rmse_focus.pdf}
...
\begin{figure}[!tbp]
    \centering
    \includegraphics[width=.70\textwidth]{fig_sim_power_focus.pdf}
...
\begin{figure}[!tbp]
    \centering
    \includegraphics[width=.70\textwidth]{fig_sim_coverage_null_focus.pdf}
