...
\begin{figure}[H]
    \centering
    \includegraphics[width=.78\textwidth]{fig_sim_rmse_focus.pdf}
    \caption{RMSE in the non-null simulation run ($\theta=1$).}
    \label{fig:app-sim-rmse}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=.78\textwidth]{fig_sim_power_focus.pdf}
    \caption{Power in the non-null simulation run ($\theta=1$).}
    \label{fig:app-sim-power}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=.78\textwidth]{fig_sim_coverage_null_focus.pdf}
    \caption{Coverage in the null simulation run ($\theta=0$). The dashed line marks nominal 95\% coverage.}
