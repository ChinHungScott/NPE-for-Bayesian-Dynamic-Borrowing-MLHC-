...
\subsection{Additional Simulation Figure}

Figure~\ref{fig:app-sim-rmse} provides the remaining non-null point-estimation
summary. Power and null-run coverage are already reported in
Tables~\ref{tab:sim-full-nonnull} and \ref{tab:sim-full-null}, so we do not
repeat those plots here.

\begin{center}
    \includegraphics[width=.68\textwidth]{fig_sim_rmse_focus.pdf}
