...
\begin{minipage}{.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{fig_sim_rmse_focus.pdf}\par
    \vspace{-0.8em}
    {\footnotesize (a) RMSE in the non-null run.}
\end{minipage}\hfill
\begin{minipage}{.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{fig_sim_power_focus.pdf}\par
    \vspace{-0.8em}
    {\footnotesize (b) Power in the non-null run.}
\end{minipage}

\vspace{0.4em}
\begin{minipage}{.52\textwidth}
    \centering
    \includegraphics[width=\linewidth]{fig_sim_coverage_null_focus.pdf}\par
    \vspace{-0.8em}
    {\footnotesize (c) Coverage in the null run.}
\end{minipage}
\captionof{figure}{Additional simulation summaries not shown in the main text.}
