...
\subsection{ADNI Sensitivity to the External-Shift Scale}
\label{app:adni-sensitivity}

Table~\ref{tab:adni-delta-sensitivity} reports a sensitivity analysis for the
ADNI-specific NPE model. For each value of $\delta_{\mathrm{sd}}$, the model was
trained five times with different random seeds. Values in parentheses denote
standard deviations across training seeds.

\begin{table}[h]
\centering
\small
\caption{ADNI sensitivity analysis over the external-shift training scale.}
