...
Figures~\ref{fig:app-sim-rmse}--\ref{fig:app-sim-null-coverage} provide the remaining simulation operating characteristics. They are consistent with the main-text figures: the largest methodological differences appear through bias and interval calibration under outcome drift or joint mismatch, while power is near one in most non-null settings.

\begin{center}
    \includegraphics[width=.66\textwidth]{fig_sim_rmse_focus.pdf}
    \captionof{figure}{RMSE in the non-null simulation run ($\theta=1$).}
    \label{fig:app-sim-rmse}
\end{center}

\begin{center}
    \includegraphics[width=.66\textwidth]{fig_sim_power_focus.pdf}
    \captionof{figure}{Power in the non-null simulation run ($\theta=1$).}
    \label{fig:app-sim-power}
\end{center}

\begin{center}
    \includegraphics[width=.66\textwidth]{fig_sim_coverage_null_focus.pdf}
    \captionof{figure}{Coverage in the null simulation run ($\theta=0$). The dashed line marks nominal 95\% coverage.}
    \label{fig:app-sim-null-coverage}
\end{center}
