...
\centering
\small
\caption{Representative results in the harder settings ($N_c=100$).}
\label{tab:sim-hard-summary}
\begin{tabular}{llccc}
\toprule
Scenario & Method & \shortstack{Bias\\($\theta=1$)} & \shortstack{Coverage\\($\theta=1$)} & \shortstack{Type I Error\\($\theta=0$)} \\
\midrule
SC3 & PSPower      & 0.9587 & 0.00 & 1.00 \\
SC3 & IW           & 0.6597 & 0.00 & 1.00 \\
SC3 & Commensurate & 0.8586 & 0.00 & 1.00 \\
SC3 & NPE          & 0.1518 & 1.00 & 0.02 \\
\cmidrule(lr){1-5}
SC5 & PSPower      & 0.9547 & 0.00 & 1.00 \\
SC5 & IW           & 0.6557 & 0.00 & 1.00 \\
SC5 & Commensurate & 0.8564 & 0.00 & 1.00 \\
SC5 & NPE          & 0.1299 & 1.00 & 0.04 \\
\cmidrule(lr){1-5}
SC6 & PSPower      & 0.3222 & 0.32 & 0.68 \\
SC6 & IW           & 0.0733 & 0.92 & 0.08 \\
SC6 & Commensurate & 0.2075 & 0.54 & 0.46 \\
SC6 & NPE          & 0.0668 & 0.98 & 0.06 \\
\bottomrule
\end{tabular}
\end{table}
