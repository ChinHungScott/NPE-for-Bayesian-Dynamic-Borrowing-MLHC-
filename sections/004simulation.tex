...
These timings exclude the one-time offline NPE training cost and measure only
the time needed to analyze a new current--external dataset pair.
As shown in Table~\ref{tab:runtime-online}, IW and PSPower are fastest in this
implementation.
However, NPE still runs at millisecond scale after training and is much faster
than the commensurate model.
The one-time NPE training run took 46.8 seconds; relative to the commensurate
model, this cost is recovered after approximately 45 repeated analyses.
