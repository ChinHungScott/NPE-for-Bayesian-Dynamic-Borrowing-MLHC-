...
We interpret this result as evidence that the ADNI-specific NPE formulation can
recover the later-cohort risk level in this example, not as evidence of greater
precision.
