...
wider. We therefore interpret the ADNI result as evidence that the NPE
formulation can recover the later-cohort risk level in this example, not as
evidence of greater precision.
...
formulation is centered close to the concurrent target, with a wider posterior
interval than the commensurate comparator. We do not view this as a
