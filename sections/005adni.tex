...
shift parameter, $\delta_{\mathrm{sd}}$, from 0.50 to 1.25 and repeated each
setting over five training seeds. The posterior mean of $\theta$ remained
stable, ranging from $-1.57$ to $-1.59$, and the posterior standard deviation
remained close to 0.86. The 95\% interval width also changed only modestly,
from 3.40 to 3.36 (Table~\ref{tab:adni-delta-sensitivity}).
