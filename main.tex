...
% ---------------------------------------------------------------
\title[Neural Posterior Estimation for Bayesian Dynamic Borrowing]{%
...
computationally expensive when fit separately for each new dataset pair.
We study amortized neural posterior estimation (NPE) as a flexible alternative
for dynamic borrowing under cohort shift.
The method is trained offline on simulated current/external dataset pairs and
...
mismatch while retaining a computationally efficient inference pipeline.
\end{abstract}
